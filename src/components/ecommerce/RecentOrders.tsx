...
import { getOrderApi } from '../../api/modules';
import {
  getOrderStatusColor,
  OrderStatusLabel,
} from '../../pages/order/models/orderStatus.interface';
...
export default function RecentOrders() {
  ...
  const getOrder = async () => {
    const orderResponse = await getOrderApi(1, null, null, null, null, null, 5);
    const { docs } = orderResponse;
                ...
                <TableRow key={order._id} className="">
                  <TableCell className="py-3">
                    <div className="flex justify-start gap-3">
                      <div className="flex justify-start  items-center h-[50px] w-[50px] overflow-hidden rounded-md">
                        <img
                      ...
                      <div>
                        ...
                        <span className="text-gray-500 text-center text-theme-xs dark:text-gray-400">
                          Size: {order.orderItems[0].product.size}
                        </span>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell className="py-3 text-center text-gray-500 text-theme-sm dark:text-gray-400">
                    {toVNDFormat(order.orderItems[0].price)}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
