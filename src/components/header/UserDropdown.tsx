...
import { getProfileApi } from '../../api/modules';
...
export default function UserDropdown() {
  ...
  const getUser = async () => {
    try {
      ...
      setUserInfo(user as ICurrentUser);
    } catch (error) {
      ...
      {userInfo && (
        <div className="relative">
          ...
          >
            ...
            <span className="block mr-1 font-semibold text-theme-sm">
          ...
          >
            <div>
              <span className="block font-semibold text-gray-700 text-theme-sm dark:text-gray-400">
                ...
                <Badge color="success">{userInfo.roles[0].name}</Badge>
              </span>
