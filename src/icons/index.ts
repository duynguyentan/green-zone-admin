...
import { ReactComponent as VoucherIcon } from './voucher.svg?react';
import { ReactComponent as TeaIcon } from './tea.svg?react';
import { ReactComponent as DashBoardIcon } from './dashboard.svg?react';
import { ReactComponent as StoreIcon } from './store.svg?react';
import { ReactComponent as ToppingIcon } from './topping.svg?react';
...
import { ReactComponent as PaymentMethodIcon } from './payment-method.svg?react';
import { ReactComponent as PaymentStatusIcon } from './payment-status.svg?react';
import { ReactComponent as ShippingMethodIcon } from './shipping-method.svg?react';
